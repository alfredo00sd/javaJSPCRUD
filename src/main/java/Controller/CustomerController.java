...
public class CustomerController extends HttpServlet {
    ...
    String list = "views/customer/List.jsp";
    String add = "views/customer/Add.jsp";
    String edit = "views/customer/Edit.jsp";
    String viewAccess = "";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(action.equalsIgnoreCase("list")) {
            ...
            //Go to add new form view
            viewAccess = add;
        }else if(action.equalsIgnoreCase("edit")) {
            //Go to edit item form view
...
//
//        }else{
            customer.setPhoto(request.getParameter("avatar"));
            customer.setName(request.getParameter("inputName"));
            customer.setLastName(request.getParameter("inputLastName"));
            customer.setBirthDay(request.getParameter("inputBirthDay"));
            customer.setAge(getAgeFromBirthDay(request.getParameter("inputBirthDay")));
